...
export default function JournalPage() {
    ...
    const tabs = [
        { id: "entries" as TabType, label: t('tabs.entries'), count: entries.length },
        { id: "analytics" as TabType, label: t('tabs.analytics'), count: null },
        { id: "meanings" as TabType, label: t('tabs.cardMeanings'), count: cardMeanings.length },
    ];
        ...
        return (
            <div className="min-h-screen pt-20 bg-gradient-to-br from-gray-900 via-gray-800 to-purple-900 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-gray-400">{t('loadingJournal')}</p>
                </div>
            </div>
        );
    }
